...
public class UserInfoControllersTest {
    ...
    NewUserInfoRequest newUserInfoRequest() {
        return NewUserInfoRequest.builder().firstName("Dung").lastName("Le Van").email("levandung.it03@gmail.com")
            .genderId(1).dob(LocalDate.of(2003, 12, 11)).build();
    }

    @Test
    public void registerUserInfo_user_valid() throws Exception {
        var req = this.newUserInfoRequest();
        var expected = UserInfo.builder().user(null).lastName(req.getLastName()).firstName(req.getFirstName())
            ...
            .build();
        Mockito.when(userInfoService.registerUserInfo(req,
    ...
    @Test
    public void registerUserInfo_user_invalidPatternFirstName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidTypeFirstName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_tooLongFirstName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_nullFirstName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_tooShortFirstName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidPatternLastName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidTypeLastName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
                .replaceFieldOfContent("lastName", 1234)
    ...
    @Test
    public void registerUserInfo_user_tooLongLastName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_nullLastName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_tooShortLastName() throws Exception {
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_nullDob() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidTypeDob() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidConstraintDob() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_nullGenderId() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidTypeGenderId() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidConstraintGenderId() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_nullEmail() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
    ...
    @Test
    public void registerUserInfo_user_invalidPatternEmail() throws Exception{
        mockMvc
            .perform(mockAuthRequestBuilders
                .setContent(this.newUserInfoRequest())
