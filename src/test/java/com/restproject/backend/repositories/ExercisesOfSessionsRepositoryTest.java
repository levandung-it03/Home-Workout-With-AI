...
//            List.of(
//                MusclesOfExercises.builder().exercise(exercises.get(0)).muscleEnum(Muscle.CHEST).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(1)).muscleEnum(Muscle.BICEPS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(2)).muscleEnum(Muscle.LEG).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(3)).muscleEnum(Muscle.BACK_LATS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(0)).muscleEnum(Muscle.TRICEPS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(1)).muscleEnum(Muscle.BACK_LATS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(2)).muscleEnum(Muscle.ABS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(3)).muscleEnum(Muscle.BICEPS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(1)).muscleEnum(Muscle.ABS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(4)).muscleEnum(Muscle.ABS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(5)).muscleEnum(Muscle.ABS).build(),
//                MusclesOfExercises.builder().exercise(exercises.get(6)).muscleEnum(Muscle.ABS).build()
//            )));
...
//                    exeHasMusRes.getMuscleList().add(exeHasMusDB.getMuscleEnum().toString());
//            }
//        }
//
...
//                        .muscleList(new ArrayList<>(List.of(exeHasMusDB.getMuscleEnum().toString())))
//                        //--All of Beginner Level exercises belong to session (with just testing data)
...
//                    .getMuscleList().add(exeHasMusDB.getMuscleEnum().toString());
//            }
//        }
